...
@Component({
  selector: 'app-female-accessories',
  templateUrl: './female-accessories.component.html',
  styleUrls: ['./female-accessories.component.css']
})
export class FemaleAccessoriesComponent implements OnInit {
  name: string;
  cover: File;
  description:any={};
...
this.Acessories=event.target.value;
      ...
      uploadFemaleAcess(){
        ...
        uploadData.append(`${this.selectCat}_accessories_image`,this.cover,this.cover.name);
...
// this. chageporperty=`${getInput}_accessories_image`
